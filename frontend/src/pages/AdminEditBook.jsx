...
export const AdminEditBook = ({ UserRole }) => {
  ...
  // Prefill formData if product data is passed in location state
  useEffect(() => {
    if (location.state && location.state.product) {
      const product = location.state.product;
      setFormData({
        BookName: product.BookName || "",
        image: null, // image file cannot be prefilled, user can upload new
      ...
      // if (product.BookImageURL) {
      //   setImagePreview(product.BookImageURL);
      // }
    }
  }, [location.state]);
